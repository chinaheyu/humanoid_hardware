...
uint32_t can_std_transmit(can_manage_obj_t m_obj, uint16_t std_id, uint8_t *data, uint16_t len)
{
    return can_msg_bytes_send(m_obj->hcan, std_id, 0, data, len);
}

uint32_t can_ext_transmit(can_manage_obj_t m_obj, uint32_t ext_id, uint8_t *data, uint16_t len)
{
    return can_msg_bytes_send(m_obj->hcan, ext_id, 1, data, len);
}

uint32_t can1_std_transmit(uint16_t std_id, uint8_t *data, uint16_t len)
{
    return can_msg_bytes_send(&hcan1, std_id, 0, data, len);
}

uint32_t can2_std_transmit(uint16_t std_id, uint8_t *data, uint16_t len)
{
    return can_msg_bytes_send(&hcan2, std_id, 0, data, len);
}
...
uint32_t can_msg_bytes_send(CAN_HandleTypeDef *hcan,
                            uint32_t id, uint8_t is_ext_id, uint8_t *data, uint16_t len)
{
    uint8_t *send_ptr;
    uint16_t send_num;
